...
include('db.php');
$query1 = "select MovieName,MovieGenre,VerticalimagePath from movies where status='NOW SHOWING MOVIE' and MovieLanguages LIKE '%hindi%' order by MovieId desc limit 10";
